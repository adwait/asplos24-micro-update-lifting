...
dut_basename_mapping = {
    store_queue : ['cva6_lsu_model_tb.shim_i.lsu_i.i_store_unit.store_buffer_i.speculative_queue_q[{}:{}]'.format(73*(i+1)-1, 73*(i+1)-34) for i in range(4)],
    store_ptr   : 'cva6_lsu_model_tb.shim_i.lsu_i.i_store_unit.store_buffer_i.speculative_write_pointer_q[1:0]',
    commit_ptr  : 'cva6_lsu_model_tb.shim_i.lsu_i.i_store_unit.store_buffer_i.speculative_read_pointer_q[1:0]',
    serve_ptr   : 'cva6_lsu_model_tb.shim_i.lsu_i.i_store_unit.store_buffer_i.commit_read_pointer_q[1:0]',
    store_state_q   : ['cva6_lsu_model_tb.shim_i.lsu_i.i_store_unit.store_buffer_i.state_q_{}[1:0]'.format(i) for i in range(4)],
