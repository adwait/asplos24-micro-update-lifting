...
from aul.predicate import get_b_imm_sext, get_i_imm_sext, get_rd, get_rs1, get_rs2, PipelinePredicate, is_4033, reads1_from_zero, writes_to_zero, check_rs1_dep, check_rs2_dep, is_alui, is_alur
...
sodor5_itype_config = ProcessorConfig(
    NAME="sodor5_itype",
